...
class CreateDPausadosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('d_pausados', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('d_pausados');
    }
}
